...
void handle_OnConnect() {
  ...
  server.send(200, "text/html", SendHTML(temperature, humidity, BPM, SpO2, bodytemperature, alert)); 
}
...
void handle_NotFound(){
  ...
  String SendHTML(float temperature,float humidity,float BPM,float SpO2, float bodytemperature, char* alert){
  ...
  ptr +="<div class='data Body Temperature'>";
  ptr +="<div class='side-by-side text'>VITALS</div>";
  ptr +="<div class='side-by-side reading'>";
  ptr += alert;
  ptr +="</div>";
