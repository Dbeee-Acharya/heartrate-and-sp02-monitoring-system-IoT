...
float temperature, humidity, BPM, SpO2, bodytemperature, tempc;
...
void handle_NotFound(){
  ...
  String SendHTML(float BPM,float SpO2, float tempc){
  String ptr = "<!DOCTYPE html>";
  ptr +="<html>";
  ptr +="<head>";
  ptr +="<title>Patient Health Monitoring System Team-7</title>";
